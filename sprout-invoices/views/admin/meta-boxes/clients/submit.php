		...
		<div id="si-publishing-action">
			...
			if ( ! in_array( $post->post_status, array( 'publish', 'future', 'private' ) ) || 0 == $post->ID ) {
				if ( $can_publish ) : ?>
					...
					<?php submit_button( __( 'Publish', 'sprout-invoices' ), 'primary button-large', 'publish', false, array( 'accesskey' => 'p' ) ); ?>
				<?php else : ?>
					...
					<?php submit_button( __( 'Submit for Review', 'sprout-invoices' ), 'primary button-large', 'publish', false, array( 'accesskey' => 'p' ) ); ?>
				<?php endif;
			} else { ?>
